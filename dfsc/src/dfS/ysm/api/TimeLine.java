...
public class TimeLine {
	public String tLine(String server, String characterId) {
		System.out.println("TimeLine tLine method called");
        ...
        try {
        	String apiUrl = "https://api.neople.co.kr/df/servers/"+server+"/characters/"+characterId+"/timeline?limit=100&code=201,209&startDate="+URLEncoder.encode(formattedSearchDate, "UTF-8")
